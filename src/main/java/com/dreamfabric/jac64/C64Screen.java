...
//  c1541.addObserver(this);
    ...
    setKeyboard(new Keyboard(this, cia[0], memory));
    //canvas = new C64Canvas(this, DOUBLE, getKeyboard());
...
//  });
  ...
  public Image getImageFromArray() {
      BufferedImage image = new BufferedImage(SC_WIDTH, SC_HEIGHT, BufferedImage.TYPE_INT_ARGB);
      image.setRGB(0,0,SC_WIDTH,SC_HEIGHT, mem, 0, SC_WIDTH);
      return image;
  }
  ...
  public int performRead(int address, long cycles) {
    ...
    case 0xd41A:
      return poty;
    case 0xdc00:
      return getKeyboard().readDC00(cpu.lastReadOP);
    case 0xdc01:
      return getKeyboard().readDC01(cpu.lastReadOP);
    case 0xdd00:
...
//     repaint = System.currentTimeMillis();
  ...
  */
  ...
  public void mousePressed(MouseEvent e) {
    ...
    getKeyboard().setButtonval(0xff - (button1 | button2 ? 0x10 : 0));
